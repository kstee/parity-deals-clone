...
import { ChevronDownIcon, View } from "lucide-react";
...
export default async function AnalyticsPage({
  ...
  const interval =
    CHART_INTERVALS[
      (await searchParams).interval as keyof typeof CHART_INTERVALS
          ...
          <div className="flex gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                ...
                <TimezoneDropdownMenuItem searchParams={searchParamsResolved} />
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
        </HasPermission>
